...
class GitHubPublishingTargetTests(unittest.TestCase):
    def setUp(self):
        ...
        self.value["authentication"]["github"] = {
            ...
            "repositories": [{"repository": "example/images", "environment": "production",
    ...
    def test_local_only_or_legacy_targets_cannot_enable_github_publication(self):
        for value, message in ((target_value(), "authorize GitHub OIDC"),
                               (legacy_target_value(2), "version 3")):
